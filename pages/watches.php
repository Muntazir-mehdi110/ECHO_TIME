...
// Step 1: Get all subcategories of the main category
$subcategories = [];
...
// Step 2: Combine parent and subcategory IDs
$all_category_ids = array_merge([$category_id], $subcategories);

// Step 3: Build placeholders for SQL IN clause
...
<main class="shop-page">
    <div class="shop-header">
        <h2>⌚ Explore Our Premium Watches</h2>
    ...
    <?php if (empty($products)): ?>
        <p class="no-products">No watches found in this category.</p>
    <?php else: ?>
